				...
				<div className="row masonry-active justify-content-between mt-6">
						...
						<div className="project-item rounded-4 overflow-hidden position-relative p-md-4 p-3 bg-white">
							...
							<div className="d-flex align-items-center mt-4">
								<Link href="/work-single" className="project-card-content">
									<h3 className="fw-semibold">Nxt Trendz</h3>
									{/* <p>Bokeh network</p> */}
								</Link>
					...
					<div className="filter-item col-lg-6 col-12 webdesign brand dataanalysis brand">
						<div className="project-item rounded-4 overflow-hidden position-relative p-md-4 p-3 bg-white">
							...
							<div className="d-flex align-items-center mt-4">
								<Link href="/jobby" className="project-card-content">
									<h3 className="fw-semibold">Jobby</h3>
									{/* <p>Tech Innovators Inc.</p> */}
								</Link>
								<Link href="/jobby" className="project-card-icon icon-shape ms-auto icon-md rounded-circle">
									<i className="ri-arrow-right-up-line" />
								</Link>
							</div>
						</div>
					...
					<div className="filter-item col-lg-6 col-12 ui app">
						<div className="project-item rounded-4 overflow-hidden position-relative p-md-4 p-3 bg-white">
							...
							<div className="d-flex align-items-center mt-4">
								<Link href="/foodmunch" className="project-card-content">
									<h3 className="fw-semibold">Food Munch(Responsive WebPage) </h3>
									{/* <p>HealthTrack Solutions</p> */}
								</Link>
								<Link href="/foodmunch" className="project-card-icon icon-shape ms-auto icon-md rounded-circle">
									<i className="ri-arrow-right-up-line" />
								</Link>
							</div>
						</div>
					...
					<div className="filter-item col-lg-6 col-12 app app dataanalysis brand">
						<div className="project-item rounded-4 overflow-hidden position-relative p-md-4 p-3 bg-white">
							...
							<div className="d-flex align-items-center mt-4">
								<Link href="/food-delivery" className="project-card-content">
									<h3 className="fw-semibold">Food Delivery App</h3>
									{/* <p>Creative Pulse Studios</p> */}
								</Link>
								<Link href="/food-delivery" className="project-card-icon icon-shape ms-auto icon-md rounded-circle">
									<i className="ri-arrow-right-up-line" />
								</Link>
							</div>
						</div>
