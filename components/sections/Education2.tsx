										...
										<ul className="ps-3">
											<li className="position-relative z-1 mb-3">
												<div className="d-flex gap-2">
													<p className="text-300 text-nowrap fw-regular mb-0">2021-2025:</p>
													<div>
														<span className="text-primary-2">Anna University </span>
														<p className="text-dark">Bachelor’s Degree in Electronics and Communication Engineering </p>
													</div>
												</div>
											</li>
											<li className="position-relative z-1 mb-3">
												<div className="d-flex gap-2">
													<p className="text-300 text-nowrap fw-regular mb-0">2023-2025:</p>
													<div>
														<span className="text-primary-2">Nxtwave Descriptive Technologies </span>
