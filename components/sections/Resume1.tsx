			...
			<section id="resume" className="section-resume-1 position-relative pt-150 overflow-hidden" data-background="assets/imgs/projects/projects-1/background.png">
								...
								<div className="resume-card-item px-4 py-3 mt-5">
										<div className="d-flex align-items-end">
											<div>
												...
												<h5>Industry Ready Certification  </h5>
												<p className="text-300 mb-0">
												Nxtwave disruptive technologies </p>
											</div>
											<h3 className="text-linear-1 ms-auto fw-semibold">9.8<span className="fs-4 fw-bold">/10</span></h3>
										</div>
									</div>
									<div className="resume-card-item px-4 py-3 mt-5">
										<div className="d-flex align-items-end">
											<div>
												...
												<p className="text-300 mb-0">Anna University</p>
											</div>
											<h3 className="text-linear-1 ms-auto fw-semibold">8.9<span className="fs-4 fw-bold">/10</span></h3>
										</div>
									</div>
									...
									<div className="resume-card-item px-4 py-3 mt-5">
										<div className="d-flex align-items-end">
											<div>
												...
												<p className="text-300 mb-0">Vidhya Vikas Matric Hr Sec School</p>
											</div>
											<h3 className="text-linear-1 ms-auto fw-semibold">87<span className="fs-4 fw-bold">/100</span></h3>
										</div>
									</div>
									<div className="resume-card-item px-4 py-3 mt-5">
										<div className="d-flex align-items-end">
											<div>
												...
												<h5>Secondary School Education 
												</h5>
												<p className="text-300 mb-0">Mary Ward Matric Hr Sec School</p>
											</div>
											<h3 className="text-linear-1 ms-auto fw-semibold">83<span className="fs-4 fw-bold">/100</span></h3>
										</div>
									</div>
								</div>
							</div>
							...
							<div className="resume-card p-lg-6 p-4 h-100">
								...
								<div className="resume-card-body">
									<div className="resume-card-item px-4 py-3 mt-5">
										...
										<p className="text-300 mb-0">Cad+t Solutions</p>
									</div>
									<div className="resume-card-item px-4 py-3 mt-5">
										<p className="fw-extra-bold text-linear-1 mb-2">2023 - 2024</p>
				...
				<div className="scroll-move-right position-relative pb-160 pt-lg-150">
					<div className="d-flex align-items-center gap-5 wow img-custom-anim-top position-absolute top-50 start-50 translate-middle">
						<h3 className="stroke fs-150 text-uppercase text-white"> branding, development, and user interface (UI)</h3>
					</div>
				</div>
			</section>
