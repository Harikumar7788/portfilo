									...
									<div className="swiper-wrapper">
										...
										<SwiperSlide>
											<div className="bg-white card-testimonial-1 p-lg-7 p-md-5 mx-3 mx-md-0 p-4 border-2 rounded-4 position-relative">
												...
												<h6 className="mb-7">“Hari is a quick learner who adapts swiftly to new challenges and technologies. He consistently delivers high-quality work that exceeds expectations, showcasing his strong problem-solving skills.</h6>
												<Link href="/#" className="d-flex align-items-center">
													{/* <img className="icon_65 avatar" src="/assets/imgs/testimonials/testimonials-1/avatar-1.png" alt="infinia" /> */}
													<h6 className="ms-2 mb-0">Senior Trainer<span className="fs-6 fw-regular"> Nxtwave</span></h6>
												</Link>
										...
										<SwiperSlide>
											<div className="bg-white card-testimonial-1 p-lg-7 p-md-5 mx-3 mx-md-0 p-4 border-2 rounded-4 position-relative">
												...
												<h6 className="mb-7">“Working with Hari on our e-commerce project was a great experience. His React skills and design sense ensured the platform’s success</h6>
												<Link href="/#" className="d-flex align-items-center">
													{/* <img className="icon_65 avatar" src="/assets/imgs/testimonials/testimonials-1/avatar-1.png" alt="infinia" /> */}
													<h6 className="ms-2 mb-0">— Frontend Developer<span className="fs-6 fw-regular"> - Project Team</span></h6>
												</Link>
												<div className="position-absolute top-0 end-0 m-5">
													<svg xmlns="http://www.w3.org/2000/svg" width={52} height={52} viewBox="0 0 52 52" fill="none">
														<g clipPath="url(#clip0_551_13914)">
										...
										<SwiperSlide>
											<div className="bg-white card-testimonial-1 p-lg-7 p-md-5 mx-3 mx-md-0 p-4 border-2 rounded-4 position-relative">
												...
												<h6 className="mb-7">“Completed 50+ projects in Nxtwave and specialized in React.js, Node.js, Express.js, and MongoDB. Enhanced problem-solving skills by solving 200+ coding challenges. Consistently achieved 90%+ scores in hands-on coding modules.”</h6>
												<Link href="/#text-primary" className="d-flex align-items-center">
													{/* <img className="icon_65 avatar" src="/assets/imgs/testimonials/testimonials-1/avatar-2.png" alt="nxtwave" /> */}
													<h6 className="ms-2 mb-0"><span className="fs-6 fw-regular"> — Nxtwave Mentor</span></h6>
												</Link>
		{/* <div className="position-absolute top-0 end-0 m-5">
			<svg xmlns="http://www.w3.org/2000/svg" width={52} height={52} viewBox="0 0 52 52" fill="none">
				<g clipPath="url(#clip0_551_13914)">
						...
						<rect width={52} height={52} fill="white" />
										...
										{/* <SwiperSlide>
											<div className="bg-white card-testimonial-1 p-lg-7 p-md-5 mx-3 mx-md-0 p-4 border-2 rounded-4 position-relative">
												...
												<h6 className="mb-7">“Working with Hari was an absolute pleasure. His attention to detail and user-focused design approach significantly improved our product's usability”</h6>
												<Link href="/#" className="d-flex align-items-center">
													<img className="icon_65 avatar" src="/assets/imgs/testimonials/testimonials-1/avatar-1.png" alt="infinia" />
				...
				<div className="shape-1 position-absolute bottom-0 start-50 z-1 ms-10 ps-10 d-none d-md-block">
					{/* <img className="position-relative z-1" src="../../public/assets/imgs/hero/man.png" alt="man" /> */}
