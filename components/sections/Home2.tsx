    ...
    <>
      <section id="about" className="section-hero-2 position-relative pt-130 pb-3">
          ...
          <div className="border border-1 rounded-3">
            <div className="box-linear-animation position-relative z-1">
              <div className="row align-items-center py-60">
                {/* Left Section (Man Image and Icon) */}
                <div className="col-lg-5 ps-lg-5 text-lg-start text-center position-relative">
                ...
                {/* Right Section (Text and Marquee) */}
                    ...
                    <div className="text-secondary-2 d-flex align-items-center">
                      ...
                      <div className="text-dark">
                        <div className="typewriter">
                          <h1 className="fs-6 fw-medium">Hey, I’m Hari</h1>
                        </div>
                      </div>
                      &lt;/span&gt;
                    </div>
        ...
        <div className="background position-absolute top-0 start-0 w-100 h-100">
          <img className="bg-w img-fluid" src="assets/imgs/home-page-2/hero-1/bg.png" alt="zelio" />
          <img className="bg-d img-fluid" src="assets/imgs/home-page-2/hero-1/bg-dark.png" alt="zelio" />
        </div>
      </section>
    </>
  )
