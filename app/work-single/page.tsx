							...
							<div className="row">
								<div className="col-lg-8 mx-lg-auto mb-lg-0">
									<div className="text-center">
										...
										NxtTrendz is a comprehensive e-commerce platform inspired by Flipkart, designed to provide users with a seamless online shopping experience. The project replicates essential e-commerce functionalities, allowing users to browse products, add them to carts, and complete secure transactions.
										</p>
									</div>
								</div>
								<div className="d-flex flex-wrap justify-content-center gap-4 py-8">
									...
									<div className="bg-6 px-5 py-3 rounded-2">
										...
										<Link href = "https://harihknxttrendz.ccbp.tech/">harihknxttrendz.ccbp.tech
										</Link>
									</div>
								</div>
																			<Image 
					...
					<section id="contact" className="section-contact-1 bg-900 position-relative pt-150 pb-lg-250 pb-150 overflow-hidden">
								...
								<div className="col-lg-4 d-flex flex-column">
									<div className="d-flex align-items-center mb-4 position-relative d-inline-flex">
										...
										<div className="ps-3">
											...
											<h6 className="mb-0">+6374037769</h6>
										</div>
									...
									<div className="d-flex align-items-center mb-4 position-relative d-inline-flex">
										...
										<div className="ps-3">
											...
											<h6 className="mb-0">Coimbatore TamilNadu </h6>
										</div>
										<Link href="https://maps.app.goo.gl/j28SHuLK4aod8zRSA" className="position-absolute top-0 start-0 w-100 h-100" />
									</div>
								</div>
						...
						<div className="scroll-move-right position-absolute bottom-0 start-50 translate-middle-x bg-900 overflow-hidden">
							<div className="wow img-custom-anim-top">
								<h3 className="stroke fs-280 text-lowercase text-900 mb-0 lh-1">Hari.design</h3>
							</div>
						</div>
					</section>
				</div>
